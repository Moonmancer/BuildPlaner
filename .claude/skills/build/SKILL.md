...
!`$env:Path = [System.Environment]::GetEnvironmentVariable("Path","Machine") + ";" + [System.Environment]::GetEnvironmentVariable("Path","User"); Set-Location "F:\Dev\BuildPlaner"; npm run build 2>&1 | Select-Object -Last 25`
